    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      <div className="bg-ebcont-magnolia p-8 rounded shadow-2xl shadow-ebcont-darkviolet  border-2 border-ebcont-darkviolet transition-all">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="p-2 w-60 h-60 min-w-[180px] flex items-center shadow-ebcont-darkviolet justify-center bg-white rounded-none shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300">
            {base64Logo ? (
              <img
                src={base64Logo}
        ...
        <hr className="my-6 border border-ebcont-darkviolet" />
