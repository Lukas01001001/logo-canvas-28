...
export function ClientListModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      <div className="flex flex-col h-full text-ebcont-darkviolet bg-ebcont-magnolia">
        {/* Filters row */}
        <div className="flex flex-col gap-2 mb-2">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full">
            <input
              ...
              className="w-full md:w-1/2 border border-ebcont-darkviolet bg-white text-ebcont-darkviolet placeholder-ebcont-darkviolet px-4 py-2 rounded-none focus:outline-none focus:ring-2 focus:ring-ebcont-activviolet transition font-medium"
            />

            <select
              value={industry}
              onChange={(e) => setIndustry(e.target.value)}
              className="w-full md:w-1/4 border border-ebcont-darkviolet bg-white text-ebcont-darkviolet placeholder-ebcont-darkviolet px-4 py-2 rounded-none focus:outline-none focus:ring-2 focus:ring-ebcont-activviolet transition font-medium"
            >
            ...
            <div className="flex-1 flex justify-end w-full mt-2 md:mt-0">
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-2 border-ebcont-fuchsia text-ebcont-fuchsia font-semibold bg-white px-4 py-2 rounded-none text-base transition
               hover:bg-ebcont-fuchsia hover:text-white focus:outline-none focus:ring focus:ring-ebcont-fuchsia"
              >
                Clear Filters
              </Button>
            </div>
          ...
          <div className="flex gap-2 items-center">
            ...
            <span
              className="ml-auto text-lg text-ebcont-darkviolet"
              aria-live="polite"
              aria-atomic="true"
          ...
          {checkedClients.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {visibleClients.map((c) => (
                <span
                  key={c.id}
                  className="bg-ebcont-activviolet text-white text-xs px-2 py-0.5 rounded font-medium"
              ...
              {extraCount > 0 && (
                <span className="bg-ebcont-activviolet text-white text-xs px-2 py-0.5 rounded font-medium">
                  +{extraCount} more
                </span>
              )}
            </div>
        ...
        {/* List of clients */}
        <div className="flex-1 min-h-0 border-t-2 border-ebcont-darkviolet">
            ...
            {loading || fetching ? (
              ...
              <ul className="space-y-2 mt-2">
                {clients.map((client) => (
                  <li
                    key={client.id}
                    className={`flex items-center gap-4 p-3 border rounded-none bg-white transition-all duration-150 font-semibold
        ${
          checked.includes(client.id)
            ? "border-2 border-ebcont-darkviolet bg-ebcont-magnolia"
            : "border-ebcont-darkviolet"
        }
        hover:bg-ebcont-magnolia`}
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-6 h-6 accent-ebcont-activviolet cursor-pointer rounded"
                    ...
                    {client.logoBlob ? (
                      ...
                      <div className="w-12 h-12 bg-ebcont-mint rounded flex items-center justify-center text-xs text-ebcont-darkviolet border-2 border-ebcont-darkviolet">
                        <svg
                          width={24}
                          height={24}
        ...
        {/* Footer */}
        <div className="flex justify-end gap-2 mt-4 pt-2 flex-shrink-0 border-t-2 border-ebcont-darkviolet bg-ebcont-magnolia">
          <Button
            variant="outline"
            onClick={onClose}
            size="lg"
            className="border-2 border-ebcont-activviolet text-ebcont-activviolet font-semibold bg-white px-6 py-2 rounded-none text-base transition hover:bg-ebcont-activviolet hover:text-white focus:outline-none focus:ring-2 focus:ring-ebcont-activviolet"
          >
            Cancel
          </Button>
          <Button
